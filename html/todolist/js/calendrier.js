...
function ds_template_main_above(t) {
	return '<table class="ds_box" cellpadding="0" cellspacing="0" style="top: '+ds_getleft(ds_element)+'px '+ds_gettop(ds_element)+'px" id="ds_conclass" style="display: none;">'
		 +'<tr>'
		 +'<td id="ds_calclass">'
		 +'</td>'
		 +'</tr>'
		 +'</table>' 
		 +'<table cellpadding="3" cellspacing="1" class="ds_tbl">'
		 + '<tr>'
