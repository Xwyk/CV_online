...
<body class="bg-fixed bg-1">
    ...
    <div class="main-container" style="border-radius: 10px">
        ...
        <header id="header" style="text-align: center; min-width: 532px;">
            <div id="logo" style="background-color: lightgrey; border-radius: 50px; display: inline-flex; max-height: 100px" >
                <div>
                    ...
                    <div id="portfolio">
                        <section class="clearfix">
                            ...
                            <div class="g1">
                                ...
                                <div id="showaffmoto" >
                                    <p>Projet personnel réalisé sur la problématique suivante : Comment savoir quel rapport est engagé sur une moto. Réalisation purement   éléctronique utilisant un afficheur 7 segments pour indiquer le rapport.</p>
                                </div>  
                            </div>    
                            <div class="g1">
                                <div class="image">
                                ...
                                <h5>Longboard DIY</h5>
                                <div id="showskate" >
                                    <p>Réalisation d'une presse et d'un longboard en contreplaqué. Longueur totale : 110cm. Planche composée de 3 couches de contreplaqué 6mm, et   t'une couche de fibre de verre en dessous afin de rigidifer le tout.</p>
                                </div>
                            </div>      
                            <div class="g1">
                                <div class="image">
                                ...
                                <div id="showalarme" >
                                    <p>Projet personnel en cours. Réalisation d'un alarme pour voiture avec fonction GPS (pour suivre la voiture) et GSM (pour alerter le   propriétaire et recevoir les coordonnées sur son téléphone). Déverrouillage par combinaison d'interrupteurs et carte NFC.</p>
                                </div>
                            </div>    
                            <div class="g1">
                                <div class="image">
                                ...
                                <div id="showclavier" >
                                    <p>Réalisation, dans le cadre scolaire, d'un clavier capable de lancer des animation sonores et visuelles. Récupération des informations envoées    par un ancien clavier PS/2 avec un microcontrôleur Arduino. Ce dernier lance alors, en fonction, soit une animation sonore directement modulée en  PWM, passant par un ampi/filtre passe bande avant d'arriver sur un haut-parleur, soit un code en bluetooth, interprété par un PC, qui lui lance  une animation visuelle codée en Java.</p>
                                </div>
                            </div>  
                            <div class="g1">
                                <div class="image">
                                ...
                                <div id="showmeteo" >
                                    <p>Projet de site météo réalisé dans le cadre scolaire. Utilisation de HTML, CSS, JavaScript, JQuery, et de l'API OpenWeatherMap afin de    récupérer les informations météorologiques d'une ville choisie. <a href="html/meteo/index.html">Voir le site</a></p>
                                </div>
                            </div>
                            <div class="g1">
                                <div class="image">
                                    <img src="images/meteo.jpg" alt="btaudio" style="border-radius: 10px"/>
                                    <div class="image-overlay" style="border-radius: 10px;">
                                        <div class="image-link">
                                ...
                                <div id="showbtaudio" >
                                    <p>Projet personnel réalisé sur la thématique de rendre n'importe quel casque audio bluetooth. Conçu sur la base d'un module audio KRC-86B fonctionnant en 4.0 low energy, couplé à deux batteries pour une capacité totale de 12Ah. développement d'une fonctionnalité NFC facilitant la connection au module. Autonomie constatée en utilisation "soirée" (8h/semaine) + "trajets" (5-7h/semaine) : 9 mois.</p>
                                </div>
                            </div>
                            <div class="g1">
                                <div class="image">
                                    <img src="images/meteo.jpg" alt="3d printer" style="border-radius: 10px"/>
                                    <div class="image-overlay" style="border-radius: 10px;">
                                        <div class="image-link">
                                ...
                                <div id="show3dprinter" >
                                    <p>Projet personnel en cours. Etude et réalisation d'une imprimante 3D reprap, basée sur une Prusa i3, avec un volume d'impression d'environ 20x20x20. Le contrôleur est un arduino Mega sous Marlin. L'imprimante peut fonctionner pilotée par un PC ou en mode autonome, avec une carte SD.</p>
                                </div>
                            </div>  
                            <div class="g1">
                                <div class="image">
                                    <img src="images/meteo.jpg" alt="graph 35+" style="border-radius: 10px"/>
                                    <div class="image-overlay" style="border-radius: 10px;">
                                        <div class="image-link">
                                ...
                                <div id="showcalc" >
                                    <p>Projet personnel. Remplacement du firmware d'origine de la graph 35+ par celui de la graph 75+. Ce dernier donne accès à une rom bridée sur la 35, et permet de développer et d'intégrer des applications codées en C directement sous le menu principal.</p>
                                </div>
                            </div>    
                            <div class="g1">
                                <div class="image">
                                    <img src="images/meteo.jpg" alt="RPI minitel" style="border-radius: 10px"/>
                                    <div class="image-overlay" style="border-radius: 10px;">
                                        <div class="image-link">
                                ...
                                <div id="showrpi" >
                                    <p>Projet personnel en cours. Réutilisation d'un minitel avec intégration d'un raspberry pi zéro, et réalisation d'une carte permettant de convertir la sortie vidéo du raspberry. Intégration de bibliothèques permettant de connecter le clavier.</p>
                                </div>
                            </div>   
                            <div class="g1">
                                <div class="image">
                                    <img src="images/meteo.jpg" alt="domotique" style="border-radius: 10px"/>
                                    <div class="image-overlay" style="border-radius: 10px;">
                                        <div class="image-link">
